    ...
    internal partial class GameClientMessageHandler
    {
        internal async Task PetBreedCancel()
        {
            ...
            foreach (var pet in item.PetsList)
            {
                ...
                await user.MoveTo(nextCoord.X, nextCoord.Y);
            }
        ...
        internal async Task PetBreedResult()
        {
            ...
            switch (item.GetBaseItem().InteractionType)
            {
                ...
                case Interaction.BreedingBear:
                    ...
                    await Oblivion.GetGame().GetAchievementManager()
                        .ProgressUserAchievement(Session, "ACH_BearBreeder", 1);
                    break;
            }
        ...
        internal async Task PlaceItem()
        {
            ...
            try
            {
                ...
                CannotSetItem:
                await Session.SendStaticMessage(StaticMessage.ErrorCantSetItem);
            }
            catch (Exception e)
            {
                await Session.SendStaticMessage(StaticMessage.ErrorCantSetItem);
        ...
        internal async Task TakeItem()
        {
            ...
            else
            {
                ...
                if (owner != null)
                {
                    await owner.GetHabbo().GetInventoryComponent().AddItemToItemInventory(item, false);

                    await room.GetRoomItemHandler().RemoveFurniture(owner, item.Id);
                    /*owner.GetHabbo()
        ...
        internal async Task MoveItem()
        {
            ...
            await room.GetRoomItemHandler().OnHeightMapUpdate(oldCoords, newcoords);
        ...
        internal async Task TriggerItem()
        {
            ...
            switch (item.GetBaseItem().InteractionType)
            {
                ...
                case Interaction.RareMoplaSeed:
                {
                    if (!hasRightsOne)
                        return;
                    await PlantMonsterplant(item, room);
                    return;
                }
        ...
        internal async Task TriggerItemDiceSpecial()
        {
            ...
            await item.Interactor.OnTrigger(Session, item, -1, hasRights);
            return;
        }
        ...
        internal async Task CompleteTrade()
        {
            ...
            var userTrade = room.GetUserTrade(Session.GetHabbo().Id);
            if (userTrade != null)
                await userTrade.CompleteTrade(Session.GetHabbo().Id);
            return;
        }
        ...
        internal async Task PickUpPet()
        {
            ...
            if (pet.RidingHorse)
            {
                ...
                if (roomUserByVirtualId != null)
                {
                    ...
                    await roomUserByVirtualId.ApplyEffect(-1);
                    await roomUserByVirtualId.MoveTo(new Point(roomUserByVirtualId.X + 1, roomUserByVirtualId.Y + 1));
                }
            }
        ...
        internal async Task CancelMountOnPet()
        {
            ...
            {
                await roomUserByHabbo.MoveTo(roomUserByHabbo.X + 1, roomUserByHabbo.Y + 1);
                await roomUserByHabbo.ApplyEffect(-1);
            }
        }
        ...
        internal async Task GiveHanditem()
        {
            ...
            await roomUserByHabbo2.CarryItem(roomUserByHabbo.CarryItemId);
        ...
        internal async Task RedeemVoucher()
        {
            ...
            if (row != null)
            {
                ...
                await Session.GetHabbo().UpdateCreditsBalance();
                await Session.GetHabbo().NotifyNewPixels((int)row["extra_duckets"]);
            }

            await Session.GetHabbo().NotifyVoucher(isValid, productName, productDescription);
        }
        ...
        internal async Task MountOnPet()
        {
            ...
            if (flag)
            {
                if (pet.RidingHorse)
                {
                    ...
                    await pet.Chat(null, value[random.Next(0, value.Length - 1)], false, 0);
                }
                else if (!roomUserByHabbo.RidingHorse)
                {
                    ...
                    await room.SendMessage(await room.GetRoomItemHandler()
                    ...
                    await room.SendMessage(await room.GetRoomItemHandler().UpdateUserOnRoller(roomUserByHabbo,
                        new Point(x, y), 0u,
                    ...
                    await roomUserByHabbo.ApplyEffect(77);
            ...
            else if (roomUserByHabbo.VirtualId == pet.HorseId)
            {
                ...
                pet.RidingHorse = false;
                pet.HorseId = 0u;
                await roomUserByHabbo.MoveTo(new Point(roomUserByHabbo.X + 2, roomUserByHabbo.Y + 2));
        ...
        internal async Task SaveWired()
        {
            ...
            await WiredSaver.SaveWired(Session, item, Request);
        }
        ...
        internal async Task PlaceBot()
        {
            ...
            await room.GetRoomUserManager().DeployBot(bot, null);
            bot.WasPicked = false;
        ...
        internal async Task PlaceBuildersFurniture()
        {
            ...
            using (var adapter = await Oblivion.GetDatabaseManager().GetQueryReactorAsync())
            {
                ...
                await actualRoom.SendMessage(message);
        ...
        internal async Task ConfirmLoveLock()
        {
            ...
            if (userOne == null)
            {
                ...
                await userTwo.GetClient().SendNotif("Your partner has left the room or has cancelled the love lock.");
            ...
            if (userTwo == null)
            {
                ...
                await userOne.GetClient().SendNotif("Your partner has left the room or has cancelled the love lock.");
            ...
            {
                await userOne.GetClient().SendMessage(loock);
                userOne.LoveLockPartner = userIdTwo;
            }
            else if (userIdTwo == Session.GetHabbo().Id)
            {
                await userTwo.GetClient().SendMessage(loock);
        ...
        internal async Task EjectFurni()
        {
            ...
            if (clientByUserId != null)
            {
                ...
                await clientByUserId.GetHabbo().GetInventoryComponent().AddItemToItemInventory(item, true);
                return;
            }
